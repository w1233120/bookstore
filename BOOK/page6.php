...
<div class="reg">
  <div class="content">
    <form action="addmember.php" method="POST" name="addmemberform">  
          <table cellpadding="0" cellspacing="0">
          <img src="assets/images/S__13680647.jpg" width="32%" height="18%" align="middle">
          <tr>  
            <td colspan="3" height="10"></td>  
                    ...
                    <tr>  
                        ...
                        <td width="220px"><div align="center">
                            <input type="text"  name="account" placeholder="請輸入姓名(5-12字元)" 
                            required autocomplete="on" maxlength="12" minlength="5">*
                        </div></td>  
                        <td width="110px"><div align="center">ex:abc123</div></td>  
                    </tr>  
                    <tr>  
                        <td colspan="3" height="10"></td>  
                    </tr>
                    <tr>  
                        ...
                        <td width="220px"><div align="center">
  <input type="password" name="UserPWD" placeholder="請輸入密碼(至少6字元)" required minlength="6">*
                      </div></td>  
                        <td width="110px"></td>  
                    </tr>  
                    <tr>  
                    ...
                    <tr>  
                        <td width="120px"><div align="center">確認密碼:</div></td>  
                        <td width="220px"><div align="center">
    <input type="password" name="UserPWD_test" placeholder="請再輸入一次密碼" required>*
                      </div></td>  
                        <td width="110px"></td>  
                    </tr>  
                    <tr>  
                    ...
                    <tr>  
                        <td width="120px"><div align="center">姓    名:</div></td>  
                        <td width="220px"><div align="center">
                          <input type="text" name="name" required/>*
                        </div></td>  
                        <td width="110px"><div align="center">ex:葉大雄</div></td>  
                    </tr>  
                    <tr>  
                        <td colspan="3" height="10"></td>  
                    </tr>  
                    <tr>  
                        ...
                        <td><div align="center">
                          <input type="radio" name="UserSex"  value="men" checked>
                          男
                      <input type="radio" name="UserSex"  value="women" >女</div></td>  
                        <td></td>  
                    </tr>  
                    <tr>  
                        <td colspan="3" height="10"></td>  
                    ...
                    <tr>  
                        <td><div align="center">手機:</div></td>  
                        <td><div align="center">
                          <input type="text" name="phonenumber" maxlength="10" minlength="10" required />
                        </div></td>  
                        <td><div align="center">ex:0987654321</div></td>  
                    </tr> 
                   		<td colspan="3" height="10"></td>
                    <tr>  
                        <td><div align="center">地址:</div></td>  
                        <td><div align="center">
                          <input type="text" name="adrees"/>
                        </div></td>  
                        <td><div align="center">ex:新北市新莊區中正路510號</div></td>  
                    </tr>   
                    <tr>  
                        <td colspan="3" height="10"></td>  
                    </tr>  
                    <tr>  
                        <td colspan="2"><div align="center">
                          <input type="button" value="提交" class="btn" onclick="checkdata()"/>
...
<section class="cid-qVHZ9NcwQ9 mbr-parallax-background" id="footer5-z">
  ...
  <script>
      function checkdata(){
          if(document.addmemberform.UserPWD.value!=document.addmemberform.UserPWD_test.value){
              alert("密碼欄位與密碼確認欄位一定要相同喔");
              return false;
          }else{
